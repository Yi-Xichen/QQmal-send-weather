...
class Spider:
    ...
    def get_weather(self):
        ...
        today_weather = '气温：{} | 湿度：{} | 天气：{} | 风向：{} | 风级：{} | aqi指数：{}'.format(today_temperature, today_humidity, today_info, today_direct, today_power, today_aqi)
...
# 发送邮件
class Mail:
    def __init__(self, weather__content, _sender, _receivers):
        # 第三方 SMTP 服务
    ...
    def send(self):
        ...
        content = MIMEText(self.content, 'utf-8')
...
def main():
    ...
    mail = Mail(text, _sender=sender, _receivers=receivers)
    mail.send()
    time.sleep(5)
